...
import li.mofanx.epso.isActivityVisible
...
// https://github.com/mofanx/epso/issues/697
// https://github.com/mofanx/epso/issues/698
private fun showA11yToast(message: CharSequence) {
    ...
    runMainPost(Toast.LENGTH_SHORT.toLong()) {
        try {
