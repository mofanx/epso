...
import li.mofanx.epso.data.UserInfo
import li.mofanx.epso.data.otherUserMapFlow
import li.mofanx.epso.permission.allPermissionStates
import li.mofanx.epso.shizuku.currentUserId
...
private val filesDir: File by lazy {
    val markFile = app.filesDir.resolve(".epso")
    if (markFile.isFile) {
        app.filesDir
    } else {
        // fix #1333
...
fun buildLogFile(): File {
    ...
    tempDir.resolve("epso-${META.versionCode}-v${META.versionName}.json").also {
